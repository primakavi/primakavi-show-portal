...
export default function NewAcquisitionClient({
  ...
  venues: Venue[];
  createAcquisition: (formData: FormData) => Promise<void>;
  initialVenueId?: string;
}) {
  const initialVenue = useMemo(
    () =>
      venues.find(
        (venue) => venue.id === initialVenueId
      ) || null,
      ...
      <div className="mx-auto max-w-5xl space-y-5">
        ...
        <header className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-zinc-500">
              Neue Akquise für eine bestehende Location anlegen.
            </p>
          </div>
        ...
        >
          ...
          <section className="rounded-[1.7rem] bg-white p-6 shadow-xl shadow-black/[0.04] ring-1 ring-black/5">
            ...
            {/* NOCH KEINE LOCATION AUSGEWÄHLT */}
                  ...
                  {filteredVenues.length === 0 && (
                    <div className="px-4 py-5 text-center">
                      ...
                      <p className="mt-1 text-xs text-zinc-400">
                        Die Spielstätte ist vermutlich noch nicht
                        im CRM.
                      </p>
                    </div>
                  )}
