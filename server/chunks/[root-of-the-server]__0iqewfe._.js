...
"[project]/primakavi-show-portal/app/api/show/[token]/files/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, { params }) {
    ...
    const { data: show, error: showError } = await __TURBOPACK__imported__module__$5b$project$5d2f$primakavi$2d$show$2d$portal$2f$app$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("shows").select("id").eq("token", token).single();
    if (showError || !show) {
    ...
    const { data: files, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$primakavi$2d$show$2d$portal$2f$app$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("show_files").select("*").eq("show_id", show.id).order("uploaded_at", {
        ascending: false
    });
    if (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$primakavi$2d$show$2d$portal$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(request, { params }) {
    ...
    const { error: uploadError } = await __TURBOPACK__imported__module__$5b$project$5d2f$primakavi$2d$show$2d$portal$2f$app$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].storage.from(BUCKET_NAME).upload(storagePath, arrayBuffer, {
    ...
    const { error: dbError } = await __TURBOPACK__imported__module__$5b$project$5d2f$primakavi$2d$show$2d$portal$2f$app$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("show_files").insert({
        show_id: show.id,
        file_type: fileType,
        file_name: file.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0iqewfe._.js.map